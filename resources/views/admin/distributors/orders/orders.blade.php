            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form_edit" id="form_edit" enctype="multipart/form-data"
                        ...
                        <input type="hidden" name="user_id" id="edit_user_id" class="form-control">
                        ...
                        <div class="mb-2 form-group">
                            ...
                            <select id="edit_time" name="time" class="form-control">
                        ...
                        <div class="mb-2 form-group">
                            ...
                            <select id="edit_package" name="package" class="form-control" type="date">
    ...
    <script>
        ...
        $(document).ready(function() {
                $(document).on('click', '.edit_btn', function(event) {
                    ...
                    $('#edit_package').val(button.data('package'))
