            ...
            <div class="modal-body">
                <form class="form_edit" id="form_edit" enctype="multipart/form-data" action="{{ route('dist.subscription.renewal')  }}"  method="POST">
                    ...
                    <div class="mb-2 form-group">
                        ...
                        <select name="time" class="form-control" type="date">
                            <option disabled selected>اختر مدة الاشتراك</option>
            ...
            <div class="card radius-10 w-100">
                <div class="card-header bg-transparent">
                    <div class="row g-3 align-items-center">
                        <div class="col">
                            <h5 class="mb-0">@lang(' الاشتراكات المنتهية  ')</h5>
                        </div>
...
@section('js')
    <script>
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('dist.subscription.getdataexpired') }}",
                },
