                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center justify-content-end gap-3 cursor-pointer">
                                <div class="dropdown">
                                    <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown" aria-expanded="false"><i  class="fadeIn animated bx bx-plus-medical text-success font-22 text-option"></i>
                                    </a>
