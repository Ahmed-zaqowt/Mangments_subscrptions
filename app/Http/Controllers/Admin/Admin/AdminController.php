            ...
            ->addColumn('mobile' , function($qur){
              ...
              ->addColumn('status' , function ($qur) {
                if($qur->status == Subscription::WAITING){
                    return '<div class="badge rounded-pill alert-info">طلب معلق </div>'  ;
                    ...
                    return '<div class="badge rounded-pill alert-danger">طلب ملغي </div>'  ;
                  }elseif($qur->status == Subscription::EXPIRED){
                    return '<div class="badge rounded-pill alert-warning">الاشتراك منتهي </div>'  ;
                   }elseif($qur->status == Subscription::RENEWAL){
                    return '<div class="badge rounded-pill alert-info">طلب مرسل للتجديد </div>'  ;
                   }
              })
